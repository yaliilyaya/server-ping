 ...
 */
final class Version20220616205835 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__service_command AS SELECT id, type, data, is_active FROM service_command');
        $this->addSql('DROP TABLE service_command');
        $this->addSql('CREATE TABLE service_command (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, data CLOB NOT NULL COLLATE BINARY --(DC2Type:json)
        , is_active BOOLEAN NOT NULL)');
        $this->addSql('INSERT INTO service_command (id, type, data, is_active) SELECT id, type, data, is_active FROM __temp__service_command');
        $this->addSql('DROP TABLE __temp__service_command');
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_D988938F33E1689A ON service_job (command_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE service_command ADD COLUMN status VARCHAR(255) NOT NULL COLLATE BINARY');
        $this->addSql('DROP INDEX IDX_D988938FDD03F01');
        $this->addSql('DROP INDEX UNIQ_D988938F33E1689A');
        $this->addSql('CREATE TEMPORARY TABLE __temp__service_job AS SELECT id, connection_id, command_id, result, data, is_active, status FROM service_job');
        $this->addSql('DROP TABLE service_job');
